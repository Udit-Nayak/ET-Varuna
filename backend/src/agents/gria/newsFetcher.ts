...
const TRUSTED_SOURCE_REGISTRY: SourceAdapter[] = [
  ...
  },
  {
    ...
    kind: "rss",
    providerType: "RSS",
    enabled: () => process.env.GRIA_INCLUDE_DIRECT_RSS === "true",
  ...
  },
  {
    ...
    kind: "rss",
    providerType: "RSS",
    enabled: () => process.env.GRIA_INCLUDE_SECONDARY_RSS === "true",
  ...
  },
  {
    ...
    kind: "rss",
    providerType: "RSS",
    enabled: () => process.env.GRIA_INCLUDE_GOVERNMENT_RSS === "true",
  ...
  },
  {
    ...
    kind: "rss",
    providerType: "RSS",
    enabled: () => process.env.GRIA_INCLUDE_SECONDARY_MARITIME_RSS === "true",
